...
import { CreatedByMeMissionsList, CreatedByMeMissionItem } from '@pages/assassin'
import { Column, Spinner, Table } from '@components/UI'

type MissionsListTableProps = {
  missionListQuery: UseQueryResult<CreatedByMeMissionsList>;
  missionTableColumns: Column<CreatedByMeMissionItem>[];
}

export function CreatedByMeMissionsListTable({ missionListQuery, missionTableColumns }: MissionsListTableProps) {
